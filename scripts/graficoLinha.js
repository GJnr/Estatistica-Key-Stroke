google.charts.load('visualization', 'current', {'packages':['corechart', 'table'], 'callback':drawCurve});
...
function drawCurveQ(){
  var data = google.visualization.arrayToDataTable([
    ['number', 'Q3', 'Q1'],
    [1, calcQ3(dadosCarregados[0]), calcQ1(dadosCarregados[0])],
    [2, calcQ3(dadosCarregados[1]), calcQ1(dadosCarregados[1])],
    [3, calcQ3(dadosCarregados[2]), calcQ1(dadosCarregados[2])],
    [4, calcQ3(dadosCarregados[3]), calcQ1(dadosCarregados[3])],
    [5, calcQ3(dadosCarregados[4]), calcQ1(dadosCarregados[4])]
  ]);
